...
contract MscpVesting30M is Ownable {
    ...
    uint256 constant private SUPPLY = 25500000 * 10**18;
    ...
    function getTotalReleased() external view returns(uint) {
        if(bonusGiven[msg.sender])
            return SUPPLY - remainingCoins[msg.sender] + 4500000 * 10**18;
        return SUPPLY - remainingCoins[msg.sender];
    }
